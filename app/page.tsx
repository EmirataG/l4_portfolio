...
export default function Home() {
  return (
    <div className="min-h-screen bg-[url('../images/bg.jpg')] bg-cover bg-center bg-no-repeat bg-fixed flex flex-col justify-center items-center">
      <div className="bg-white/80 size-fit p-4 pb-6 rounded-xl flex flex-col shadow-md">
        <Header />
        <section className="flex-1 place-self-center w-1/2 min-w-102 max-h-64 overflow-scroll">
